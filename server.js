...
const db = {
  users: [
    ...
    { id: 3, name: 'Carlos', surname: 'Pérez', email: 'carlos.perez@nomada.es', password: '1234', role: 'ADMIN', active: true },
    { id: 4, name: 'Ana', surname: 'Sánchez', email: 'ana.sanchez@nomada.es', password: '1234', role: 'EDITOR', active: true },
    { id: 5, name: 'Sofía', surname: 'Oliveira', email: 'sofia.oliveira@nomada.es', password: '1234', role: 'EDITOR', active: true },
    { id: 6, name: 'David', surname: 'Thimotheo', email: 'david.thimotheo@nomada.es', password: '1234', role: 'VIEWER', active: true },
  ],
  hotels: [
...
app.get('/api/users/activos', (req, res) => { res.json(db.users.filter(u => u.active)); });
...
// ============ VIAJES ============
app.get('/api/travels', (req, res) => { res.json(db.travels); });
...
app.get('/api/dashboard', (req, res) => {
  console.log(`[DASHBOARD] Dashboard consultado`);
  res.json({
...
// ============ TRIP SEGMENTS ============
app.get('/api/trip-segments', (req, res) => { res.json([]); });
...
║                                                               ║
║  👨‍💼 EMPLEADOS (NOMADA):                                        ║
║     Email: carlos.perez@nomada.es  / Contraseña: 1234        ║
║     Email: ana.sanchez@nomada.es   / Contraseña: 1234        ║
║     Email: sofia.oliveira@nomada.es / Contraseña: 1234       ║
║     Email: david.thimotheo@nomada.es / Contraseña: 1234      ║
║                                                               ║
║  👤 USUARIO:                                                  ║
